    ...
    <div className="space-y-6 animate-fade-in">
            ...
            {isLoading ? (
              ...
              <>
                <p
                  className={cn(
                    "text-3xl font-bold",
                    analytics?.growthRate !== undefined && analytics.growthRate >= 0 ? "text-green-400" : "text-red-400"
                  )}
                >
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent className="relative">
            {isLoading ? (
              ...
              <>
                <p className="text-3xl font-bold text-yellow-400">{analytics?.actionItemStats.completionRate || 0}%</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-xl">
          ...
          <CardContent>
            {isLoading ? <Skeleton className="h-64 w-full" /> : <ActionItemsChart stats={analytics?.actionItemStats} />}
          </CardContent>
        </Card>
      </div>
